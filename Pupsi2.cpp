...
/// [main]
{
  ...
  size_t executable_name_idx = program_path.rfind("Pupsi");
...
/// [registration setup]
  ...
  libfreenect2::Frame undistorted(512, 424, 1), registered(512, 424, 1);
/// [registration setup]
...
/// [loop start]
    ...
    cv::Mat frame = cv::imread("/home/ivs/Desktop/lena.jpg", 0);
